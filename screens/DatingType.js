...
const DatingType = () => {
  ...
  const typeOptions = ["Men", "Women", "Everyone"]
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          This helps us show you the most relevant matches. You can change this anytime.
        </Text>
        ...
        <View style={styles.optionsContainer}>
          {typeOptions.map((type) => (
            ...
            >
              ...
              />
              <Text style={[styles.optionText, selectedType === type && styles.selectedOptionText]}>{type}</Text>
            </TouchableOpacity>
          ))}
        </View>
